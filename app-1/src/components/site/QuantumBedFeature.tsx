  ...
  <section className="mx-auto w-full max-w-[100rem] px-5 py-16 sm:px-8 sm:py-24">
    <div className="mx-auto max-w-4xl text-center">
      ...
      <h2 className="mx-auto mt-4 max-w-4xl font-heading text-4xl font-semibold text-page-foreground sm:text-5xl">
        Новый уровень расслабления с Квантовой кроватью
      </h2>
      <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-muted-ui-foreground sm:text-lg sm:leading-8">
        Откройте современный формат SPA-отдыха. Квантовая кровать дополняет
        атмосферу спокойствия аппаратной технологией — вам остаётся лишь удобно
        расположиться, расслабиться и посвятить эти минуты себе.
      </p>
    </div>

...
const MaxIcon = ({ className }: ComponentPropsWithoutRef<"img">) => (
  <img alt="" aria-hidden="true" className={className} src={maxLogo} />
);
...
const socialLinks = [
  ...
  [
    ...
    "https://max.ru/u/f9LHodD0cOL0VewR62PaaLMctALvpuEzyx7CKLU-LDIX6YeVuhIHhVcc6SM",
    MaxIcon,
  ],
] as const;

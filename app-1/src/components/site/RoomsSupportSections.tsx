...
const PlacementRequestModal = ({
  ...
  <LeadRequestModal
    commentPlaceholder="Расскажите, какой формат размещения вас интересует"
    description="Оставьте контакты, и мы свяжемся с вами, чтобы подобрать подходящий вариант размещения."
    emailRequired
    eyebrow="Заявка на размещение"

...
При поиске нескольких номеров бронирование проходит в два последовательных шага: сначала гость выбирает категорию номера для текущей позиции, затем выбирает тариф для неё. После подтверждения тарифа интерфейс возвращает к выбору следующего номера; справа в сводке сохраняется отдельная категория и тариф для каждой позиции. Карточки тарифов показывают преимущества тегами и имеют раскрываемый блок с подробным описанием и условиями отмены.

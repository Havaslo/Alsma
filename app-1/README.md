...
Блок «Локации, блюда и примеры событий» на странице торжеств наполнен карточками шатра, банкетного зала «Белый», зала «Цветной», зала ресторана и выездной регистрации на природе. Вместимость и особенности локаций хранятся в `src/lib/site/celebrations.ts`.

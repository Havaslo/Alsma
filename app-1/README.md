...
Кнопка «Забронировать» в шапке и CTA «Найти номер» в Hero главной страницы ведут на маршрут `/booking`. Форма под Hero остаётся доступной как отдельный блок на главной странице.

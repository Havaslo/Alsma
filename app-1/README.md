...
В карточках актуальных акций описание ограничено четырьмя строками и обрезается многоточием. Кнопка «Подробнее» открывает модальное окно с полным описанием, изображением и кнопкой перехода по ссылке, сохранённой для акции в административной панели.

...
export const getVoiceInstructions = async (database: Database) => {
  ...
  return [
    ...
    "Если гость просит менеджера или оператора, сначала коротко сообщи о переводе, затем немедленно вызови transfer_to_manager. После вызова перевода не продолжай разговор и не обещай перевод без вызова инструмента.",

...
export const bookingCancellationRequestBodySchema = z.object({
  bookingId: z.string().uuid(),
...
export type BookingCancellationRequestBody = z.infer<
  typeof bookingCancellationRequestBodySchema
>;

...
const defaultVoiceScenarios = [
  {
    ...
    enabled: true,
    response:
      "Первой фразой скажи дословно: «Разговор может записываться для контроля качества обслуживания.» Не заявляй срок хранения, удаление записей или иной порядок хранения: они не подтверждены технической политикой этого агента.",
    title: "Голос: уведомление о возможной записи",
    trigger: "opening,recording-disclosure",
  },
  {
    channels: ["voice"],
    enabled: true,

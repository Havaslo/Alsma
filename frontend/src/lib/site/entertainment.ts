...
export const EQUIPMENT = [
  {
    description: "Инвентарь для активных прогулок и отдыха у воды в тёплый сезон.",
    items: [
  ...
  {
    description: "Снаряжение для снежных прогулок и зимних развлечений всей семьёй.",
    items: ["Беговые лыжи", "Классические санки", "Ватрушки", "Снегоступы"],
    title: "Зимний спорт",
  },
  {
    description: "Всё для дружеских матчей, настольных игр и спокойного досуга на природе.",

            ...
            <AnimatePresence>
              {isOpen && position && (
                <m.div
                  ...
                  className="fixed z-50 overflow-hidden rounded-3xl border border-line/70 bg-panel/95 text-panel-foreground shadow-2xl shadow-page-foreground/15 backdrop-blur-xl focus:outline-none"
                ...
                >
                  <Calendar
                    ...
                    value={calendarDate}
                  />
                  <footer className="grid grid-cols-2 gap-2 border-t border-line/60 bg-muted-ui/20 p-3">
                    <button
                      className="min-h-10 rounded-xl px-3 text-sm font-semibold text-muted-ui-foreground transition hover:bg-muted-ui/70 hover:text-panel-foreground focus-visible:ring-4 focus-visible:ring-focus/15 focus-visible:outline-none disabled:opacity-40"
                    ...
                    <button
                      className="min-h-10 rounded-xl bg-brand/10 px-3 text-sm font-semibold text-brand transition hover:bg-brand/15 focus-visible:ring-4 focus-visible:ring-focus/15 focus-visible:outline-none"
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        type="button"
      >
        <span className={selectedDate ? undefined : "text-muted-ui-foreground"}>
          {displayValue}
        </span>
        <CalendarDays
          aria-hidden="true"
